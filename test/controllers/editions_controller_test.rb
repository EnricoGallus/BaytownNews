...
class EditionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create edition" do
    assert_difference("Edition.count") do
      post editions_url, params: { edition: { desc: @edition.desc, distribution: @edition.distribution, number: @edition.number, title: @edition.title } }
    end
  ...
  test "should update edition" do
    patch edition_url(@edition), params: { edition: { desc: @edition.desc, distribution: @edition.distribution, number: @edition.number, title: @edition.title } }
